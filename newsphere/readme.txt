...
* Update - Uses proper HTML5 elements
* Update - Ensures headings follow a logical order
* Update - Elementor Swiper compatibility
* Update - Block Style improvement
* Fixed - Some styling glitch

= 4.3.0 - Dec 25 2024 =
* New - SEO improvement
* New - Uses proper HTML5 elements
* New - Ensures headings follow a logical order
* New - Elementor Swiper compatibility
* Update - Block Style improvement
* Fixed - Some styling glitch
...
= 3.2.6 - Aug 08 2023 = 
* Update - Archive image improvements
* Update - Block design improvements
* Update - Fixed some design glitch

= 3.2.5 - Jul 25 2023 = 
* Fixes - Banner improvements
* Update - Block design improvements
* Update - Fixed some design glitch

= 3.2.4 - May 31 2023 = 
* Fixes - Category color class select improvements
* Update - Block design improvements
* Update - Fixed some design glitch
...
= 3.2.2 - May 12 2023 =
* Update - Block design improvements
* Update - Dark mode tags-links improvements
* Update - Single post header read details background improvements
* Update - Comment links and excerpt link improvements
* Update - Slider on sidebar offcanvas and footer widget area improvements
* Update - Block design improvements
* Update - Fixed some design glitch
