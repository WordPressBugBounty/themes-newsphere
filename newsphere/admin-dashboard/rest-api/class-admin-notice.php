    ...
    function newsphere_dashboard_notice_content(){
		if ( file_exists( WP_PLUGIN_DIR . '/af-companion/af-companion.php' ) ) {
			if(is_plugin_active('af-companion/af-companion.php')){
				$af_companion_title = __( 'Get Starter Sites', 'newsphere' );
				$af_companion_url = site_url( ).'/wp-admin/admin.php?page=af-companion';
			}else{
            $af_companion_title = __( 'Activate AF Companion', 'newsphere' );
            ...
            $af_companion_title = __( 'Install AF Companion', 'newsphere' );
		...
		$demo_link = "https://afthemes.com/products/newsphere/";
		...
		$notice_external_msg =sprintf(
			...
			esc_html__( 'Return to your dashboard', 'newsphere' )
